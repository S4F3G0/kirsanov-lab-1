document.addEventListener("DOMContentLoaded", () => {
    ...
    const inputBtn = document.getElementById("inputBtn") as HTMLButtonElement;
    const nameInput = document.getElementById("nameInput") as HTMLInputElement;
    const outputText = document.getElementById("greetingOutput") as HTMLParagraphElement;
...
const str: string = "Пример строки";
...
const anyVar: any = "Может быть чем угодно";
...
const edgeBtn = document.getElementById("calcVolumeBtn") as HTMLButtonElement;
const edgeInput = document.getElementById("edgeInput") as HTMLInputElement;
const volumeOutput = document.getElementById("volumeOutput") as HTMLParagraphElement;
